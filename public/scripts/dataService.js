(function() {
  ...
  angular.module('app').service('dataService', function($http) {
    ...
    this.updateRecipeById = function(id, recipeObject, successCallback, errorCallback) {
      $http.put('/api/recipes/' + id, recipeObject)
        .then(successCallback, errorCallback);
    };

    this.addRecipe = function(recipeObject, successCallback, errorCallback) {
